...
MANUAL_SEED_HANDLES = [
    ...
    "ektadb_speaks",
    "healing_notes_",
    "advocating.mentalhealth",
    "dr.kellyvincent",
    "thisisyolandarenteria",
    "ashparaskevas",
    "drheidigreen",
    "heykellyellen",
    "thepsychologistandme",
    "mindwellness.dr.era",
    "thrive_withmeg",
    "kate_speer",
    "drsamanthaboardman",
    ...
    "holistic.therapist",
    "realtalk.therapist",
    "pattersonperspective",
    "no.bs.therapist",
    "feminist.mom.therapist",
    "laurenurie.therapy",
    "drebonyonline",
    "paging.dr.chanda",
    ...
    "drtraceymarks",
    "exploring.therapy",
    "the.betrayal.trauma.therapist",
    "the.mom.therapist",
    "marcelailustra",
    "story.of.the.mind",
    "itsthecwolf",
    "sportsfoodandmentalhealth",
    "drdelvena",
    "thepatricenicole",
    "jademathisofficial",
    "dr.rheedawalker",
    ...
    "drrashipsychiatrist",
    "drrachelnyc",
    "kelly.the.cbt.psychologist",
    "margaretnagib",
    "dr.psychandstyles",
    "drhassanyasin",
    "thepsychologist.co",
    "hollyfisherhiggins",
    "jeffditzellpsychiatry",
    "drtashbinnie",
    "therapy.with.emilee",
    "maristracke",
    "al.mindful.therapist",
    "tychonxcarter",
    ...
    "thepeoplestherapist",
    "dr.ajitarobinson",
    "wellness_therapistnyc",
    "francispsychotherapy",
    "therealsashanicole",
    "nicolelewislcsw",
    "eboniharrisma",
    "one_phoenixrising",
    "healthymindshealthyhearts",
    "lakeedajohnsontv",
    "drjshopkins",
    "kabodcounseling",
    "kellyu",
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--manual-count", type=int, default=len(MANUAL_SEED_HANDLES))
    parser.add_argument(
        "--aggregator-count", type=int, default=len(AGGREGATOR_SEED_HANDLES)
    )
